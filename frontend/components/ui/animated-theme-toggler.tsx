...
/**
 * Animated Theme Toggler — sun↔moon morph (adapted to framer-motion +
 * next-themes so the choice persists). A soft switch-click sounds on toggle.
 */
...
export function AnimatedThemeToggler({
  ...
  return (
    <motion.button
      ...
      className="flex h-8 w-8 items-center justify-center rounded-md text-foreground/80 outline-none transition-colors hover:bg-muted focus-visible:ring-2 focus-visible:ring-ring"
